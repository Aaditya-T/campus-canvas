...
import { X, Send, ChevronLeft, ChevronRight, Heart, MessageCircle, Share2 } from 'lucide-react';
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="p-4 border-b-2 border-dashed border-foreground/30">
            ...
            <div className="flex items-center gap-4 pt-3 border-t-2 border-dashed border-foreground/30">
              ...
              <button className="flex items-center gap-1 hover:text-neon transition-colors ml-auto">
